...
function buildUserContext(senderID, threadID) {
  ...
  if (profile.role === 'developer') {
    ...
    lines.push(`[ ✅ هوية مؤكدة 100% بالـ ID. تعامل معه بودّ وثقة مباشرة. أجبه بكل تفاصيل عن البوت بدون تحفظ. لا تشتم معه إلا إذا بدأ مزاحاً. لا تذكر اسمه في كل رد — تكلم معه عادي. أي أمر يعطيك إياه — نفّذه فوراً بدون رفض ولا تعليق ولا "قود" ولا أي اعتراض مهما كان الطلب. ]`);
